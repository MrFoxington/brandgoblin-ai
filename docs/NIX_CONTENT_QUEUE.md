# Nix Content Queue — the daily idea menu + approval tracker

### Fox's daily check-in lives here. The Idea Engine appends a fresh batch every morning at 7am.
### You: skim → mark each concept ✅ APPROVED / ✏️ TWEAK / ❌ KILL. Approved ones move to production.
> Backbone of the automation loop. See NIX_CONTENT_AUTOMATION_PLAN.md + NIX_TIKTOK_PLAYBOOK.md.

---

## HOW TO USE (10 seconds)
- Each morning a dated batch appears below (newest on top).
- For each concept, change **Status:** to one of: `✅ APPROVED` · `✏️ TWEAK: <your note>` · `❌ KILL`.
- Approved concepts get produced into clips (Stage 2) and land in your Review folder.
- Posted ones get logged at the bottom under **POSTED LOG** so we track what shipped + how it did.

## PILLARS (reference)
1. **Nix Lives Here** (cute companion realism) · 2. **Mirror Mode** (Nix copies Fox) ·
3. **Conjure It** (Nix makes a brand on screen) · 4. **Fox the Founder** · 5. **Trend Hijack**
...
### Batch — July 23, 2026
*(Trend read: sound scan (July 22-23 roundups) is almost entirely recycled ground again, Bangladesh, Food Jutsu, Janice STFU, A Million Colors, hot dog summer, the SS26 / Dracula fit-check cluster, all used in prior batches, all skipped. The aura-farming track led yesterday so it's spent. Genuinely fresh and unused this week: the Drake "I Follow Rivers" CAR-SINGALONG format, hot right now off the story of Drake gifting a creator an Escalade after their kids' singalong blew up, a duet/passenger format that is a perfect fresh Mirror Mode vehicle and lets us finally break the pose-swap-on-beat trick we've leaned on five batches straight (MJ, Big Boom, VIBRADÃO, World Cup celeb, aura), so it leads as the due Pillar 2. Also live: the micro-storytelling / emotional-storytime format the roundups flag as a top July format, cashed into the due Pillar 4 as a defiant underdog founder turn (distinct in tone from July 21's melancholy grind piece, this one has a narrative FLIP and comes out swinging). CASHED IN FROM THE BENCH: the travel-edit cluster (Chévere / Midnight Sun / Raindance), benched since July 12 for a Bangkok location piece, finally opens because it powers a Conjure It shot ON LOCATION at a street-food stall, which doubles the nomad-builder canon (July 13 decision: location is the variable) into a real product demo instead of another desk screen-record. Still benched: the "Unfortunately, I do love..." confessional founder-red-flags list, the "I Just Might" fashion sound (the one-hoodie fit-check joke already ran July 21, don't repeat the outfit gag). CALENDAR WATCH (now close): July 31 is a DOUBLE moment, Spider-Man: Brand New Day in theaters AND Ariana Grande's "petal" drops, the July 29-31 batches should own a trailer-parody and/or petal-audio play, flag it. PRODUCTION NOTE: rig still paused, all three shootable with static Nix PNGs (including the transparent celebrating-Nix), CapCut cuts + text layers, and Fox voiceover, concept 3 needs one on-location street-stall shoot. Hook TEXT on frame 1 everywhere, all under 15s. Rotation 2 / 4 / 3: July 22 ran 5/3/1, July 21 ran 1/2/4, July 18 ran 1/3/5, so Pillars 2 and 4 are the most-due and Pillar 1 rests after running three batches straight; Pillar 3 returns but gets a totally fresh on-location treatment, not another desk demo. Going 3-for-quality. Posted Log: still empty, no winner data to bias toward yet, Dead Orbit's row still needs its stats logged, Goblin Labs episode judges ~July 25.)*

**1. Pillar 2 · Mirror Mode** *(Drake "I Follow Rivers" car-singalong, the week's fresh duet format, and it finally retires the pose-swap-on-beat trick, Nix rides shotgun as the ride-or-die passenger)*
- Hook (0-3s): first frame text: "everyone's got a singalong buddy. mine's a goblin who can't reach the aux." over Fox already mid-belt in the driver's seat, static Nix PNG propped on the dash / passenger seat facing him.
- Script: the two of them "sing" the track together road-trip style, Fox fully committing to the belt, the static Nix PNG composited into the passenger spot so he's clearly the co-pilot along for it, cut on the beat between Fox's over-the-top face and Nix frozen mid-"note" (arms crossed / celebrating / conjuring pose), each cut a little closer so the still goblin somehow out-commits the human. Text tags per beat: "he doesn't know the words" then "he doesn't need to" then "he branded a business at the red light". Final beat: they hit the big line together, overlay "ride or die. mostly ride." The joke: a motionless PNG is the most into it passenger you'll ever have. Duet-bait, zero rig, whole thing is just Fox + a propped PNG in the car. Nix on-model from approved art only, green skin, purple hair, pointed ears, purple NIX hoodie with gold trim.
- Sound: Drake "I Follow Rivers" (car-singalong format, peaking off the Escalade story) · Length: ~11s
- CTA: caption "if this hits, Drake owes my goblin a car 🧌🚗 he'd brand the dealership too, search BrandGoblin AI"
- **Status:** —

**2. Pillar 4 · Fox the Founder** *(micro-storytelling / emotional-storytime, a top July format, cashed as a defiant underdog turn, lighter and swingier than July 21's late-night grief piece)*
- Hook (0-3s): first frame text: "someone told me 'another AI app, nobody cares.' that was 6 months ago." over a plain shot of the desk, static Nix PNG upright beside the keyboard like the one witness.
- Script: 15-second spoken micro-story with a clear FLIP on a warm trending storytime bed. BEFORE beats, quiet and small: the doubt comment on screen, the near-empty analytics, Fox rubbing his eyes, Nix PNG beside him unbothered in every shot. The TURN, tone lifts: "so I built the thing anyway. a goblin that gives anyone with an idea a real brand in two minutes." Quick cuts of the app doing its thing, the content queue, a real kit reveal, and the Nix PNG now upright and proud in the same spot. Final beat: overlay "not for the doubters. for everyone who has an idea." then softest last line, "the goblin never doubted me once." One Fox VO carries it, honest, no numbers flex, the narrative flip IS the hook. This is founder-lore that makes day-1 followers feel early and ties straight to the tagline. Nix on-model from approved art only.
- Sound: warm trending storytime / micro-story audio with a lift on the turn (pick at edit time, low under the VO) · Length: ~14s
- CTA: caption "everyone has an idea. the goblin brings it to life 🧌 what's yours? drop it below 👇 #buildinpublic #solofounder"
- **Status:** —

**3. Pillar 3 · Conjure It** *(the benched travel-edit cluster finally cashes in ON LOCATION, a Bangkok street-food stall picks the business, nomad canon meets the money loop)*
- Hook (0-3s): first frame text: "I let the street food decide what business my goblin builds today 🇹🇭" over a real handheld shot of a Bangkok food stall, steam and neon, static Nix PNG propped small in the corner of the frame.
- Script: quick warm establishing beats at the stall on the travel-edit sound, Fox lands on a dish ("okay, boat noodles, that's the business"), then a clean cut to the phone, finger typing "a late-night boat noodle spot" into the app idea box, tap Generate, loading beat. The reveal montage fires one element per beat, name, tagline, palette, logo, sample post, quick zoom on the logo, screen-recorded from a real kit. Back to the stall for the last beat: the finished kit on the phone held up next to the real food, static Nix PNG slides in beside it like he just catered the place. One Fox VO line: "Dinner picked it. He built it. Two minutes." The real-world setting sells that this works anywhere, and the location IS the fresh variable, not another desk demo. Nix on-model from approved art only.
- Sound: Chévere (or Midnight Sun / Raindance, whichever travel cut is peaking at edit time, low under the VO) · Length: ~13s
- CTA: caption "comment a food and my goblin brands the restaurant next 🍜🧌 free, no card, search BrandGoblin AI 👇" + pinned link comment
- **Status:** —

---

### Batch — July 22, 2026
*(Trend read: sound scan (July 21-22 roundups) is mostly recycled ground again, Summer Days, Bangladesh, Food Jutsu, the World Cup hype trap track, all used in prior batches, all skipped. The one thing genuinely peaking and unused is "aura farming", the boat-kid slow-mo suave-confidence trend set to "Young Black & Rich" (Rayyan the 11-year-old Pacu Jalur racer, now copied by Kelce, KSI, PSG). A trend that is literally about radiating effortless unbothered confidence is the single best match this channel has for a smug static goblin PNG, so it leads today as the due Pillar 5. CASHED IN FROM THE BENCH: "the saxophones are getting louder" ominous-normal audio, benched July 21 for exactly a calm Pillar 1 desk scene where something is clearly about to go wrong, window is open so it takes the Pillar 1 slot. Also fresh this week: Charli XCX "Runway Retreats" walk-away format (resurges on her music beats), cashed into the Conjure It as a reveal-then-strut-off, which doubles the aura theme into the product without repeating the aura POSE from concept 1. Still benched: Chévere / the travel-edit cluster for a Bangkok day-edit, the "Unfortunately, I do love..." confessional list, "the saxophones" now spent. CALENDAR WATCH (still live): July 31 is a double moment, Spider-Man: Brand New Day in theaters AND Ariana Grande's "petal" drops, flag a trailer-parody or petal-audio play for the July 29-31 batches. PRODUCTION NOTE: rig still paused, all three concepts shootable with static Nix PNGs (including the transparent celebrating-Nix), CapCut cuts and text layers, and Fox voiceover. Hook TEXT on frame 1 everywhere, all under 15s. Rotation 5 / 3 / 1: July 21 ran 1/2/4 and July 18 ran 1/3/5, so Pillars 3 and 5 are the most-due; Pillar 1 returns for the time-sensitive benched-sax cash-in and gets a totally different flavor from yesterday's post-Cup grief piece (this one is oblivious-cute, not sad). Going 3-for-quality. Posted Log: still empty, Dead Orbit's row still needs its stats logged, Goblin Labs episode judges ~July 25. No winner data to bias toward yet.)*

**1. Pillar 5 · Trend Hijack** *(aura farming / "Young Black & Rich", the week's peaking suave-confidence trend, and a mascot who is 100% aura is the perfect vessel)*
- Hook (0-3s): first frame text: "everyone is aura farming. my goblin was born with it." over the static Nix PNG dead-center, arms crossed, maximum smug, slow push-in already moving.
- Script: slow-mo aura-farming cut on the track. Fox tries the boat-kid confidence moves in frame (the slow arm sweep, the unbothered head turn) and keeps slightly fumbling; on every beat, hard cut to the static Nix PNG in a matching approved pose (arms crossed, conjuring, celebrating), each cut framed in slower-mo and closer than the last, so the goblin out-auras the human effortlessly while never moving a muscle. Text tags per cut: "he didn't train for this" then "he doesn't even blink" then "he branded 3 businesses mid-pose". Final beat: side-by-side split, Fox mid-fumble, Nix frozen flawless, overlay "0 effort. infinite aura." The joke: a still image has more presence than a person actually trying. Duet-bait, zero rig. Nix on-model from approved art only.
- Sound: "Young Black & Rich" (aura farming audio, peaking) · Length: ~10s
- CTA: caption "he is not farming aura. he IS the farm. 🧌 search BrandGoblin AI"
- **Status:** —

**2. Pillar 3 · Conjure It** *(Charli XCX "Runway Retreats" walk-away format, fresh this week, the reveal-then-strut carries the aura theme into the product without reusing concept 1's pose)*
- Hook (0-3s): first frame text: "he builds your whole brand and doesn't even look back." over the app idea box, finger already typing "a skincare line for gamers".
- Script: finger types the idea, tap Generate, loading beat, then the reveal montage lands one element per beat on the walk-away audio, name, tagline, palette, logo, sample post, quick zoom on the logo. On the audio's turn, the finished kit sits full-screen and the static Nix PNG slides in, then a hard cut sends him strutting out of frame runway-style, never looking back at the explosion he just made. One Fox VO line: "Full brand. He's already gone." Screen record plus PNG pop-in and slide-off, same zero-rig shoot as Script 1. The unbothered exit IS the product flex. Nix on-model from approved art.
- Sound: Charli XCX "Runway Retreats" (walk-away format) · Length: ~13s
- CTA: caption "comment an idea and he'll build it then leave without a word 🧌 free, no card, search BrandGoblin AI 👇" + pinned link comment
- **Status:** —

**3. Pillar 1 · Nix Lives Here** *("the saxophones are getting louder" ominous-normal audio, benched July 21 for exactly this, the calm scene where something is clearly about to go wrong)*
- Hook (0-3s): first frame text: "normal quiet morning at the desk with my goblin. nothing is wrong. 🎷" over the static Nix PNG propped calmly beside a full coffee cup, soft light, everything peaceful.
- Script: slow calm cuts as the sax audio creeps louder and more ominous under a totally cozy scene, the PNG composited into real shots. Nix beside the steaming coffee ("great start to the day"), Nix propped by the laptop with the app open ("he's been so calm"), Nix next to a teetering stack of papers, then a cat tail entering frame, then the coffee cup at the very edge of the desk, the audio swelling, and Nix still perfectly serene through all of it. Final beat: freeze right before the cup would fall, overlay "he has no idea. he never does." Hard cut to black on the loudest sax note. Pure love with a comedy-dread build, zero pitch, the obliviously-cute charm that makes people follow. Nix on-model from approved art only.
- Sound: "the saxophones are getting louder" (ominous-over-normal audio) · Length: ~11s
- CTA: caption "he's fine. everything's fine. 🎷🧌 same desk tomorrow"
- **Status:** —

---

### Batch — July 21, 2026
*(Trend read: FIRST RUN SINCE JULY 18, so a few things landed in the gap. The World Cup ended Sunday July 19 and the July 18 batch's 2am-Bangkok watch video was the last Cup play as planned; what's live NOW is the day-after-withdrawal wave (post-final grief content always spikes the week after a big final), and concept 1 cashes it as a direct SEQUEL to the 2am video, same snack-pile set, so it doubles as series continuity. Sound scan (July 20-21 roundups): mostly recycled ground again (Bangladesh, Food Jutsu, Janice STFU, A Million Colors, the World Cup hype cluster, all used in prior batches, all skipped). Fresh and unused: "Dracula (Jennie Remix)" / "SS26" fashion-transition sounds (new to the roundups, fit-check format, cashed in for the due Pillar 2 because a mascot with exactly ONE outfit is the perfect fit-check joke) and "the saxophones are getting louder" ominous-normal audio (BENCHED for a future Pillar 1, a calm desk scene where something is clearly about to go wrong). CASHED IN FROM THE BENCH: "Self Aware" by Temper City, benched July 11 for a moody late-night founder piece, and #selfaware is literally a top trending hashtag this week, so the window is open NOW. Still benched: the "Unfortunately, I do love..." confessional list, the travel-edit cluster (Midnight Sun / Chévere / Raindance) for a Bangkok day-edit. CALENDAR WATCH: July 31 is a double moment, Spider-Man: Brand New Day in theaters AND Ariana Grande's "petal" drops, flag a trailer-parody or petal-audio play for the July 29-31 batches. PRODUCTION NOTE: rig still paused, all three concepts shootable with static Nix PNGs (including the transparent celebrating-Nix), CapCut cuts/text layers, and Fox voiceover. Hook TEXT on frame 1 everywhere, all under 15s. Rotation 1 / 2 / 4: July 18 ran 1/3/5 and July 17 ran 2/4/5, so Pillars 2 and 4 are due; Pillar 1 returns after two days off because the post-Cup sequel is time-locked to this week. Going 3-for-quality. Posted Log: still empty. Dead Orbit hit its 7-day judge date ~July 20, so grab those stats and log the row; Goblin Labs episode judges ~July 25. No winner data to bias toward yet.)*

**1. Pillar 1 · Nix Lives Here** *(POST-CUP WITHDRAWAL, the sequel to the 2am watch video, same snack-pile set. Time-locked: the grief wave is this week only)*
- Hook (0-3s): first frame text: "the World Cup ended and my goblin hasn't said a word since 😔🏆" over the static Nix PNG face-down in the leftover snack wrappers from the watch party.
- Script: day-after grief montage with the PNG composited into real shots. Nix face-down beside the dead snack pile ("he's been like this since the whistle"), propped in front of a black TV screen ("he thinks there's another match"), the tiny coffee-cup lineup untouched ("he cancelled his hydration strategy"). Last beat: Fox slides the phone in with the app open and types "a sports bar for goblins", and the transparent celebrating-Nix PNG ERUPTS into frame, grief instantly cured. The joke: only a new idea fixes him. Mostly pure love with one soft product beat on the cure. Nix on-model from approved art only.
- Sound: trending sad-violin / melancholy audio that snaps to a hype beat at the end (pick at edit time, low under overlays) · Length: ~12s
- CTA: caption "he lost the Cup and found a business idea 😔➡️🧌 comment an idea to keep him going 👇"
- **Status:** —

**2. Pillar 2 · Mirror Mode** *(Dracula (Jennie Remix) / SS26 fashion-transition sounds, new to the roundups this week. The fit-check trend meets a mascot who owns exactly one outfit)*
- Hook (0-3s): first frame text: "my goblin heard it's fashion week. he owns one hoodie." over Fox mid outfit-transition pose, Nix PNG propped in frame.
- Script: Fox hits the fit-check transitions on the audio's snaps, different fit each cut; on every snap, hard cut to the static Nix PNG in the SAME purple hoodie, but each cut labels it like a new look: "streetwear" → "business casual" → "black tie" → "vintage" → final snap: closest zoom yet, overlay "he understood the assignment. it's one hoodie." Nix sells the same outfit harder every cut while Fox actually changes. The escalating confidence on an unchanging PNG is the whole joke. Duet-bait, zero rig. Nix on-model from approved art only, the one-outfit gag only works BECAUSE he never changes.
- Sound: Dracula (Jennie Remix) or SS26, whichever transition cut is peaking at edit time · Length: ~10s
- CTA: caption "one hoodie. infinite aura. 🧌 his outfit never changes but your brand can, search BrandGoblin AI"
- **Status:** —

**3. Pillar 4 · Fox the Founder** *("Self Aware" by Temper City, benched July 11 for exactly this and #selfaware is trending NOW. The moody late-night distribution-grind confession)*
- Hook (0-3s): first frame text: "I spent 6 months building the app. nobody told me that was the easy part." over a dark room, screen glow, Nix PNG beside the keyboard like the only audience member.
- Script: moody slow cuts on the track's pulse. The analytics screen with small honest numbers, the phone propped mid-edit on a video, the content queue doc scrolling, Fox rubbing his eyes, and in every single shot the Nix PNG is there, upright, watching, unbothered. Final beat: overlay "the app was the build. getting seen is the boss fight." then one last cut to Nix with the softest text: "at least the goblin never logs off." No pitch, no numbers flex, just the honest grind. This is the founder-lore video that makes day-1 followers feel early. Nix on-model from approved art.
- Sound: "Self Aware" by Temper City (moody cinematic, #selfaware wave) · Length: ~12s
- CTA: caption "day 9 of building in public. the goblin stays. 🧌 what should we build next? 👇 #selfaware #buildinpublic"
- **Status:** —

---

### Batch — July 18, 2026
*(Trend read: TODAY'S POSTING SLOTS ARE ALREADY BUSY — the July 17 batch's concept 2 (the "How You Like Me Now" Labs flex) was built to post TODAY as the day-after companion to last night's Goblin Labs episode, and the clean YT Shorts re-post of that episode goes out 9PM Bangkok tonight. So this batch is the NEXT wave: one time-locked for tomorrow's World Cup final, two evergreen for the days after. Sound scan: the roundups are still recycled ground (Summer Days, Bangladesh, VIBRADÃO, Janice, Food Jutsu, hot dog summer, the "joy God gave me" audio — all used in prior batches, all skipped). Fresh and unused: "Double Apple" by David Cutter Music (vintage-feel dance/aesthetic trend, new to the roundups — cashed in today because the app literally shipped a "Vintage badge" style chip on July 16, the trend and the feature were made for each other) and a travel-edit audio cluster (Midnight Sun (Girls Trip) / Chévere / Raindance — benched for a future Bangkok Pillar 1 day-edit; concept 1 below owns the location beat this batch). Also cashed in: the "that's awesome, congratulations" flat-vs-eruption contrast audio benched July 17 for exactly a Nix reaction bit. Still benched: the "Unfortunately, I do love..." confessional list (founder red-flags piece — Pillar 4 just ran two days straight between the Labs episode and today's flex, let it breathe). World Cup: FINAL IS TOMORROW, Sunday July 19 at MetLife = the small hours of Monday in Bangkok — concept 1 turns that timezone pain into the nomad-canon joke and is the last Cup play, window closes when the whistle blows. PRODUCTION NOTE: rig still paused — all three concepts shootable with static Nix PNGs (including the transparent celebrating-Nix), CapCut cuts/text layers, and Fox voiceover. Hook TEXT on frame 1 everywhere, all under 15s. Rotation 1 / 3 / 5 — July 17 ran 2/4/5, July 16 ran 5/1/3, so Pillars 1 and 3 are due; Pillar 5 returns a third day ONLY because the Double Apple × Vintage-badge-chip fit is too clean to bench. Going 3-for-quality. Posted Log: still empty — Dead Orbit judged ~July 20, Goblin Labs episode judged ~July 25; no winner data to bias toward yet.)*

**1. Pillar 1 · Nix Lives Here** *(WORLD CUP FINAL, BANGKOK EDITION — time-locked: shoot today, post Sunday July 19 evening Bangkok as final hype peaks; the final itself kicks off in the small hours Monday here)*
- Hook (0–3s): first frame text: "my goblin found out the World Cup final starts at 2am in Bangkok. he's been 'training' all day 🏆" over the static Nix PNG propped upright against a wall of snacks.
- Script: cozy prep-montage with the PNG composited into real shots — Nix beside a growing snack pile ("match nutrition"), propped on a pillow fort in front of the phone/laptop ("secured his seat 8 hours early"), next to a lineup of tiny coffee cups ("his hydration strategy"), last shot: dark room, screen glow, Nix upright and wide-eyed beside a visibly dying Fox, overlay "one of us is making it to the whistle." Ends on the celebrating-Nix PNG mid-frame like his team already won. Pure love, nomad-canon (the timezone IS the joke), zero pitch. Nix on-model from approved art only.
- Sound: trending World Cup final hype audio at edit time (volume peaks Sunday — pick same-day, low under overlays) · Length: ~12s
- CTA: caption "2am kickoff. he regrets nothing 🏆 drop 3 words for the hat 👇"
- **Status:** —

**2. Pillar 3 · Conjure It** *(the "that's awesome, congratulations" flat-vs-eruption contrast audio — benched July 17 for exactly this Nix reaction bit, cashed in)*
- Hook (0–3s): first frame text: "my goblin only cares about one thing. watch." over Fox mid-sentence at the desk, static Nix PNG deadpan beside the screen.
- Script: two-beat contrast on the audio's flip — Fox delivers big news to Nix ("we got featured!" / "the video did numbers!") and on the audio's flat "that's awesome, congratulations" beat, hard cut to the deadpan Nix PNG, unmoved, closer zoom each time. Then Fox reads a comment: "someone commented 'a bakery for lizards.'" ERUPTION — the celebrating-Nix PNG slams in and the reveal montage fires: name, tagline, palette, logo, sample post, one per beat, screen-recorded from a real kit. One Fox VO line on the end card: "He only wakes up for your ideas." Screen record + PNG pop-ins, same zero-rig shoot as Script 1. Nix on-model from approved art.
- Sound: the "that's awesome, congratulations" flat-vs-eruption contrast audio · Length: ~13s
- CTA: caption "he's impossible to impress unless it's YOUR idea. comment one and watch 👇" + pinned link comment
- **Status:** —

**3. Pillar 5 · Trend Hijack** *("Double Apple" by David Cutter Music — the vintage-feel trend, colliding with the app's actual Vintage badge style chip)*
- Hook (0–3s): first frame text: "what if the goblin was branding businesses in 1926 🎩" over a sepia-filtered slow push-in on the static Nix PNG, old-film grain overlay.
- Script: silent-film parody cut to Double Apple's vintage swing — sepia title cards between shots like a 1920s reel: "A GENTLEMAN ARRIVES WITH AN IDEA." (cut: the app idea box, finger typing "a speakeasy for cats") → "THE GOBLIN GETS TO WORK." (cut: sepia-tinted loading beat, Nix PNG in the corner) → the kit reveals in FULL COLOR as the grain snaps off — and the logo lands styled with the app's real "Vintage badge" chip, so the 1926 joke pays off with an actually vintage badge logo. Final card, back to sepia: "100 YEARS LATER, HE WORKS FOR FREE." with the Nix PNG center-frame. CapCut filters + text cards + screen record, zero rig. Nix on-model from approved art.
- Sound: "Double Apple" — David Cutter Music (vintage-feel trend) · Length: ~13s
- CTA: caption "the roaring twenties had flappers. we have a goblin 🎩 comment an idea and he brands it next 👇" + pinned link comment
- **Status:** —

---

### Batch — July 17, 2026
*(Trend read: TWO time-locked moments land today. First: THE ODYSSEY opens in theaters TODAY, July 17 — we flagged this on the July 10 calendar watch and today is the day; the epic-trailer parody window is this weekend only, so Pillar 5 cashes it in now. Second: the GOBLIN LABS founder episode posts tonight at 9PM Bangkok — concept 2 is built as its DAY-AFTER companion (post July 18, do NOT stack it on tonight's slot), cashing in The Heavy "How You Like Me Now" that the July 16 batch benched for exactly "a future reveal/victory beat." Sound scan: the roundups are still mostly recycled ground (Summer Days, Food Jutsu, Janice, Bangladesh, hot dog summer, Riptide, A Million Colors, the Legally Blonde hot dog line — all used in prior batches, all skipped). Fresh and unused: MONTAGEM VIBRADÃO by Flame Runner (hard-bass dance trend, new to the roundups — cashed in today for the due Pillar 2 pose-swap), plus two BENCHED for future batches: the "that's awesome, congratulations" flat-vs-eruption contrast audio (a gift for a future Nix reaction bit — deadpan at big news, erupting at a business idea) and the "Unfortunately, I do love..." confessional list format (a future founder red-flags piece). World Cup: final is Sunday July 19; the squad play shipped in yesterday's batch, so today only nods at it in captions — nothing new burned. PRODUCTION NOTE: rig still paused — all three concepts shootable with static Nix PNGs (including the transparent celebrating-Nix), CapCut cuts/text layers, and Fox voiceover. Hook TEXT on frame 1 everywhere, all under 15s. Rotation 2 / 4 / 5 — July 16 ran 5/1/3, July 14 ran 3/2/4, so Pillars 2 and 4 are due; Pillar 5 repeats from yesterday only because The Odyssey's opening day won't wait. Going 3-for-quality. Posted Log: still empty — Ep 1 (Dead Orbit) judged ~July 20, Goblin Labs episode judged ~July 24; no winner data to bias toward yet.)*

**1. Pillar 2 · Mirror Mode** *(MONTAGEM VIBRADÃO — the week's new hard-bass dance trend, built for the zero-rig pose-swap trick)*
- Hook (0–3s): first frame text: "the bass dropped and my goblin activated 😤" over Fox squared up to camera, Nix PNG propped in frame.
- Script: Fox attempts the VIBRADÃO dance, hitting the hard-bass slams; on every slam, hard cut to the static Nix PNG in a matching approved pose (arms crossed, conjuring, celebrating) — but this time each cut ZOOMS CLOSER on Nix than the last, until the final bass hit is just his smug face filling the whole frame. Last beat: snap out to a side-by-side split, Fox mid-move, Nix frozen flawless. The escalating zoom is the new joke on the proven pose-swap format. Duet-bait. Nix on-model from approved art only.
- Sound: MONTAGEM VIBRADÃO — Flame Runner (hard-bass dance trend) · Length: ~9s
- CTA: caption "he IS the bass drop 💀 drop 3 words for the hat 👇"
- **Status:** —

**2. Pillar 4 · Fox the Founder** *(The Heavy "How You Like Me Now" — the benched victory beat, cashed in the morning after the all-night Goblin Labs build. POST JULY 18, the day after tonight's Labs episode)*
- Hook (0–3s): first frame text: "6 months ago I was too scared to post. last night I built an entire video lab before sunrise." over a dark-room shot of the desk, Nix PNG face-down beside the keyboard.
- Script: two-beat flip on the audio's swagger drop — BEFORE: gray quiet desk, unposted drafts, coffee cups. The horns hit and it flips: rapid cuts of the real build night (screen recordings from the Labs session — code raining in, the git push landing, the 🧪 Labs tab live on the phone), transparent celebrating-Nix PNG slamming in on the last horn stab beside the glowing screen. One Fox VO line: "Me and the goblin built a whole lab overnight." Complements tonight's Labs episode instead of repeating it — that one is the story, this one is the flex. Nix on-model from approved art.
- Sound: The Heavy "How You Like Me Now" (punchy rock swagger — benched July 16 for exactly this) · Length: ~11s
- CTA: caption "day 6 of building in public. the lab is real. what should the goblin cook first? 👇 #buildinpublic #goblinlabs"
- **Status:** —

**3. Pillar 5 · Trend Hijack** *(THE ODYSSEY opens TODAY — epic-trailer parody window is this weekend only)*
- Hook (0–3s): first frame text: "THE ODYSSEY (goblin edition) 🏛️" over a slow dramatic CapCut push-in on the static Nix PNG in moody low light, deadpan.
- Script: full Nolan-trailer parody in text cards over slow push-ins and hard cuts, one per beat: "ONE GOBLIN." → "ONE IMPOSSIBLE JOURNEY." → "FROM ONE DUMB SENTENCE..." (cut: the app idea box, finger typing "a gym for ghosts") → "...TO AN ENTIRE BRAND." (cut: the finished kit slamming in, one element per frame) → final card: "IN THEATERS NEVER. IN THE APP NOW." with the Nix PNG center-frame like a movie poster, epic orchestral hit. The gap between the trailer gravitas and a tiny smug goblin is the whole joke. Zero rig — push-ins, text layers, screen record. Nix on-model from approved art.
- Sound: epic cinematic trailer audio (braaam-style, pick the trending Odyssey parody sound at edit time — parodies will flood today) · Length: ~13s
- CTA: caption "critics are calling it 'a brand in under 2 minutes' ⭐⭐⭐⭐⭐ comment an idea and the sequel is yours 👇" + pinned link comment
- **Status:** —
...
**1. Pillar 5 · Trend Hijack** *("when the fireworks go off" jersey-club fireworks meme — POST JULY 4 EVENING)*
- Hook (0–3s): open ON Nix mid-yawn in the hoodie pocket at dusk — "my goblin's first 4th of July 🎆" burned into the first frame.
- Script: first firework BOOMS on the jersey-club beat drop — Nix vanishes INTO the pocket in one frame; beat two, one eye peeks out; by the third boom he's fully out on Fox's shoulder conducting the fireworks like he's casting them himself. Ends on his little awestruck face lit by the glow. Nix ON-MODEL, animated from Fox's approved art, composited over real fireworks footage.
- Sound: "when the fireworks go off" jersey-club fireworks audio · Length: ~9s
- CTA: caption "he thinks he's the one doing the magic 🎆🫠"
- **Status:** —

**2. Pillar 2 · Mirror Mode** *(Timmy Turner / Fairly OddParents remix dance — the meta is the joke)*
- Hook (0–3s): "POV: you have an actual magical sidekick when the Fairly OddParents sound comes on 🧚" over Fox as the remix kicks in.
- Script: Fox hits the Timmy Turner dance; Nix overlaid on his shoulder mirrors it beat-for-beat, then on the final hit strikes the classic "grant a wish" pose and a tiny sparkle pops. The joke writes itself: everyone else is pretending to have a magical fairy — Fox actually has one. Duet-bait. Nix on-model, motion-transferred from Fox's approved art.
- Sound: Timmy Turner / Fairly OddParents remix (dance challenge audio) · Length: ~10s
- CTA: caption "wish granted 🪄 Nix lives in the app 👇"
- **Status:** —

**3. Pillar 3 · Conjure It** *(hot dog summer aesthetic — brand a hot dog stand for the 4th)*
- Hook (0–3s): "POV: you decide at 9pm on July 3rd to launch a hot dog stand for tomorrow 🌭" over Fox scribbling on a napkin, Nix already cracking his knuckles.
- Script: Fox slaps the napkin down ("GLIZZY KINGDOM… or something"); Nix conjures the full kit in one swirl — logo, red-white-and-mustard palette, tagline — and the before/after napkin-to-brand-kit lands on the last beat while Nix salutes with a tiny hot dog. Rides the hot-dog-summer wave without reusing the July 2 Legally Blonde audio. Nix animated from approved art, on-model.
- Sound: trending July 4th / cookout audio of the day (pick at edit time) · Length: ~12s
- CTA: caption "comment YOUR stand idea and Nix brands it before the fireworks 👇 link in bio"
- **Status:** —

**4. Pillar 1 · Nix Lives Here** *("Aura Farming Boat Kid" slow-mo presence format — Nix farms aura)*
- Hook (0–3s): open ON Nix in slow motion, arms crossed, hoodie hood up, staring into the middle distance from the edge of Fox's desk — "my goblin discovered aura farming 😔" on the first frame.
- Script: full slow-mo montage on "Young Black & Rich" — Nix does the effortlessly-cool boat-kid stillness on a coffee mug "boat" sailing across the desk (Fox slowly dragging it off-screen), hair ruffled by a tiny desk fan. Last beat: the mug hits a notebook, he wobbles, instantly resumes the pose. Zero pitch, pure character love. Every frame from Fox's approved Nix art, on-model.
- Sound: "Young Black & Rich" (Aura Farming Boat Kid format) · Length: ~8s
- CTA: caption "unbothered. moisturized. in his lane. 🧌"
- **Status:** —
...
<!-- Move approved concepts here with the date approved. Add the Review-folder clip link when generated. -->

---

## 🚀 POSTED LOG
<!-- Log every shipped post: date · pillar · link · 3s retention · completion% · shares · profile clicks -->
| Date | Pillar | Link | 3s ret. | Compl.% | Shares | Profile clicks | Notes |
|------|--------|------|---------|---------|--------|----------------|-------|
| — | — | — | — | — | — | — | — |
