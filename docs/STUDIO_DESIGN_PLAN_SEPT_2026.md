...
### Phase D: first-timer tips + the daily loop (1-2 sessions) · LIVE Sept 6 late night. Share card carries only the user's brand (no watermark on any tier, Fox's rule)
