  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer */}
        <div style={{ marginTop: "40px", paddingTop: "20px", borderTop: "1px solid rgba(250,247,242,0.10)", textAlign: "center" }}>
      ...
      <style>{`
        @media print {
          ...
          body { background: #141518 !important; }
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: "32px", pageBreakInside: "avoid" }}>
      <h2 style={{ fontSize: "16px", fontWeight: 800, color: "#fff", marginBottom: "12px", paddingBottom: "8px", borderBottom: "1px solid rgba(250,247,242,0.10)" }}>
        {title}
      </h2>
      {children}
    </div>
...
function cardStyle({ border = "rgba(250,247,242,0.10)", bg = "rgba(250,247,242,0.045)" }: { border?: string; bg?: string }): React.CSSProperties {
  return {
    background: bg,
